            ...
            <div className="py-16 md:py-24">
                ...
                <div className="max-w-3xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    ...
                    <button
                        ...
                        className="cursor-pointer mt-10 bg-[#2d4a43] text-white font-semibold py-3 px-6 rounded-md hover:bg-opacity-90 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2d4a43]">
