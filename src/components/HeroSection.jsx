        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-md">
          ...
          <div className="flex items-center gap-4 mt-8">
            <button
              ...
              className="bg-[#2d4a43] text-white font-semibold py-2 px-5 rounded-md hover:bg-opacity-90 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#2d4a43] cursor-pointer">
              Buy Fan Card
            </button>
            <button
              onClick={() => {
                const section = document.getElementById("meet-greet");
                if (section) {
                  section.scrollIntoView({ behavior: 'smooth' });
                }
              }}
              className="border border-gray-400 text-gray-700 font-semibold py-2 px-5 rounded-md hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 cursor-pointer">
              Join Meet & Greet
            </button>
          </div>
        </div>
